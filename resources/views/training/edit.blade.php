...
@section('judul','Form Edit Konten')
@section('isi')
    ...
    <div class="form-container">
        ...
        <form action="{{ route('training.update', $training->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="judul">
                    <i class="fas fa-graduation-cap"></i> Judul Konten 
            ...
            <div class="form-group">
                <label for="isi">
                    <i class="fas fa-map-marker-alt"></i> Isi Konten
                </label>
                <input 
                        type="text" 
                        name="isi" 
                        id="isi"
                        class="form-control-modern" 
                        placeholder="Masukkan Isi training"
                        value="{{ $training->isi}}"
                    >
            </div>
