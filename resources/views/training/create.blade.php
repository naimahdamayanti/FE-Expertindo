@extends('layout')
@section('title','Input Konten')
@section('judul','Form Input Konten')
@section('isi')
...
<style>
    ...
    <div class="page-header">
        <h2><i class="fas fa-calendar-plus"></i> Input Konten</h2>
    </div>
    ...
    <div class="form-container">
        ...
        <form action="{{ route('training.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="judul">
                    <i class="fas fa-newspaper"></i> Judul Konten
                </label>
            ...
            <div class="form-group">
                <label for="tgl_rilis">
                    <i class="fas fa-calendar-alt"></i> Tanggal Rilis
                </label>
                <div class="input-icon-wrapper">
            ...
            <div class="form-group">
                <label for="gambar">
                    <i class="fas fa-image"></i> Gambar Konten
                </label>
                <div class="input-icon-wrapper">
...
function previewImage(event) {
    ...
    if (file) {
        ...
        reader.onload = function(e) {
            preview.innerHTML = `<img src="${e.target.result}" style="max-width: 300px; max-height: 300px; border-radius: 8px;">`;
        }
